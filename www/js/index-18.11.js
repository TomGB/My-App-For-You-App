...
function clickEndApp(){
	...
	if(holdButtonTimer!==null){
		...
		//alert("go to load game");
		//alert("game number: "+heldButtonGameId);
		getGameFromMemory(heldButtonGameId);
	}
	else{
		//alert("else hold button timer");
		clearTimeout(holdButtonTimer);
		holdButtonTimer=null;
	}
...
function onGetFileSuccess(fileEntry) {
	...
	fileTransfer.download(
		'http://www.myappforyou.co.uk/img/floor1.png',
		path + 'theFile.png',
		function(file) {
